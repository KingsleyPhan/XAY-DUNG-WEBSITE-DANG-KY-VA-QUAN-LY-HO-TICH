...
AS
	...
	SELECT 
			...
			,@me_ID = me.CONGDAN_ID
	FROM DANGKY_KHAISINH ks LEFT JOIN CONGDAN cha ON KS.CHA_CMND = cha.CONGDAN_CMND LEFT JOIN CONGDAN me ON KS.CHA_CMND = me.CONGDAN_CMND,HOSO_DANGKY hsdk
...
AS
	BEGIN
		...
		RETURN
	END
SELECT * FROM Get_Giay_KhaiSinh (6)
