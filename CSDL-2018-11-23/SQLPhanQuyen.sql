...
BEGIN
	...
	EXEC PHANQUYEN @username, @Quyen_name
...
ALTER PROC PHANQUYEN @username nvarchar(50), @chucnang nvarchar(50)
AS
BEGIN
...
GRANT SELECT,INSERT, UPDATE ON PHUONG TO QUOCGIA
...
GRANT SELECT,INSERT, UPDATE ON TRANGTHAO_XULY TO CANBOHOTICH
