...
<head>
    ...
    <!--header and footer-->
        ...
        <link rel="stylesheet" type="text/css" href="./CONTENT/styles/kiemduyet.css">
</head>
            	...
            	<c:if test='${action == "KiemDuyet" }'>
	             	...
	             	<div class="row">
	                    <div class="control-navigation">
	                        ...
	                        <form action="QuanLyHoTich/insert" method="post">
            					...
            					<button type="submit" class="btn  btn-continue" onClick="submitKiemDuyet()">Tiếp tục</button>
	                        </form>
	                    </div>
	                </div>
                </c:if>
                                ...
                                <div class="title-part">
                                    ...
                                    <c:if test='${action == "KiemDuyet"}'>
	                                    <div class="col-12 col-sm-6 col-md-6" style="text-align: right; height: 100%">
	                                    	<button class="btn  btn-check" onClick="checkNgYeuCau()">Kiểm duyệt</button>
	                                    </div>
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <c:choose>
																	...
																	<div id="feedback_NYC_NGAYCAP" class="form-group has-feedback">
																		...
																		<span id="gly_NYC_NGAYCAP" class="glyphicon form-control-feedback"></span>
																	</div>
																	</c:when>
																	<c:otherwise>
										...
										<c:choose>
											<c:when test='${action == "KiemDuyet"}'>
												<c:choose>
													...
													<c:otherwise>
														<button class="btn  btn-check" onClick="getCheckKhaiSinh()">Kiểm duyệt</button>
                        ...
                        <div class="container container-paper">
                            <div class="part-content">
                            	<div class="title-part">
                                    ...
                                    <div class="col-12 col-sm-6 col-md-6" style="text-align: right; height: 100%">
                                    <c:if test='${action == "KiemDuyet"}'>
	                                    <button class="btn  btn-check" onClick="">Kiểm duyệt</button>
