            ...
            <div class="row">
                ...
                <div class="Content-TraCuu" style="height:auto">
                    ...
                    <table style="width:100%;  color: black">
                         <tr class="row-table">
                            <th class="tit"> <label class="labelFor" for="">MÃ HỒ SƠ :     </label></th>
                            <th class="contt"><p class="display-result">${maHoSo}</p></th>
                           
                          </tr>
                          <tr class="row-table">
                            <td class="tit"> <label class="labelFor" for="">LOẠI HỘ TỊCH:     </label></td>
                            <td class="contt"> <p class="display-result">${TenGiayTo}</p></td>
                          
                          </tr>

                          <tr class="row-table">
                            <td class="tit"> <label class="labelFor" for="">NGÀY ĐĂNG KÝ:     </label></td>
                            <td class="contt"> <p class="display-result">${NgayDangKy}</p></td>
                          
                          </tr>

                          <tr class="row-table">
                            <td class="tit"> <label class="labelFor" for="">EMAIL ĐĂNG KÝ:     </label></td>
                            <td class="contt"> <p class="display-result">${Email}</p></td>
                          
                          </tr>

                          <tr class="row-table">
                            <td class="tit"> <label class="labelFor" for="">SĐT ĐĂNG KÝ:     </label></td>
                            <td class="contt"> <p class="display-result">${SoDienThoai}</p></td>
                          
                          </tr>

                          <tr class="row-table">
                            <td class="tit"> <label class="labelFor" for="">TRẠNG THÁI:     </label></td>
                            <td class="contt"> <p class="display-result" style="color: red;">${TrangThai}</p></td>
