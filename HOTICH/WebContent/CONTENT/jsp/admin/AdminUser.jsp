    ...
    <div id="id-content" class="content-switch">
        ...
        <div class="container " style="width:95%">
            <div class="row">
                ...
                <div class="topnav menu-top">
                    ...
                    <a href="admin_TongQuat.html"><i class="fa fa-list fa-lg padd-icon"></i>TỔNG
                        QUAN</a>
                    <a href="admin_TongQuatNguoiDung.html" style=" background-color:rgb(243, 93, 33);"><i class="fa fa-address-book-o fa-lg padd-icon"></i>TÀI
                        KHOẢN NGƯỜI DÙNG</a>
                    <a href="#news"><i class="fa fa-cogs fa-lg padd-icon"></i>THIẾT LẬP CƠ QUAN</a>
                    <a href="#news"><i class="fa fa-cubes  fa-lg padd-icon"></i>QUẢN LÝ PHẦN MỀM</a>
                    <a href="#contact"><i class="fa fa-info-circle fa-lg padd-icon"></i>THÔNG TIN PHẦN MỀM</a>
            ...
            <div class="paper" style="margin-top: 20px;">
                <div class="titile" style="margin-top: 30px">
                    <p><i class="fa fa-list-alt" style="padding-right:10px"></i>QUẢN LÝ THÔNG TIN TÀI KHOẢN</p>
                </div>
                <div class="row" style="margin-bottom: 10px">
                    <button id="buttonAdd" onclick="functionButtonAdd(this)" class="btn add "> + CẤP TÀI KHOẢN</button>
                </div>
                <div class="row">

                    <table id="table-user-imfor" class="table table-hover table-bordered table-striped table-sm">
                        <!--Table head-->
                        <thead>
                            <tr>
               ...
               <form action="QuanLyNguoiDung" method="post">
                <div class="row">
                    <div class="col-12 col-sm-6 col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="user_MACANBO" readOnly name="user_MACANBO"
                    ...
                    <div class="col-12 col-sm-6 col-md-4">
                        <div class="form-group">
                            <label for=>Họ và Tên</label> <input type="text" class="form-control" id="user_HoVaten"
                                readOnly name="user_HoVaten" onblur="validateHoTen(user_HoVaten)">
                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" id="user_NgaySinh" name="user_NgaySinh"
                                                readOnly placeholder="Ngày/Tháng/Năm" type="text" onBlur="validateNgaySinh(user_NgaySinh)"
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-md-4">
                        <div class="form-group">
                            <label for="">Chức vụ</label> <input type="text" class="form-control" id="user_ChucVu" name="user_ChucVu"
                                readOnly>
                    ...
                    <div class="col-12 col-sm-6 col-md-4">
                        ...
                        <div class="form-group">
                            <label for="">Quyền sử dụng</label> <select id="user_Quyen" name="user_Quyen" class="form-control"
                                disabled>
                ...
                <div class="row">
                    <div class="col-12 col-sm-6 col-md-4">
                        <div class="form-group">
                            <label for="">Email</label> <input type="text" class="form-control" id="user_Email" name="user_Email"
                                readOnly>
                    ...
                    <div class="col-12 col-sm-6 col-md-4">
                        <div class="form-group">
                            <label for="">SĐT</label> <input type="text" class="form-control" id="user_SDT" name="user_SDT"
                                readOnly>
                    ...
                    <div class="col-12 col-sm-6 col-md-4">
                        ...
                        <div class="form-group">
                            <label for="">Trạng thái sử dụng </label><br> <label class="switch"> <input name="user_TrangThai"
                                    readOnly id="user_TrangThai" type="checkbox" checked> <span class="slider round"></span>
                            </label>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-md-4" id="ResetPassword">
                        <div class="form-group">
                            <label for="" style="color:brown">RESET PASSWORD (*)</label> <input type="text" class="form-control"
                                id="user_RSP" name="user_RSP" readOnly onblur="validateRequired(user_ChucVu)">
        ...
        <div class="imfor-Table">
            ...
            <div class="content-imfor">
               <p style="color: brown; font-size: 18px; font-weight: 700">HOẠT ĐỘNG CHỈNH SỬA NGƯỜI DÙNG THEO QUYỀN CỦA ADMIN LÀ HOẠT ĐỘNG CÓ QUYỀN TRUY CẬP CAO NHẤT.</p>
                <p style="color: brown; font-size: 18px; font-weight: 700">HÃY CẦN THẬN VỚI NHỮNG THAO TÁC CỦA BẠN !</p>
                <p style="color: brown; font-size: 18px; font-weight: 700">HÃY LIÊN HỆ VỚI CHÚNG TÔI KHI CẦN THIẾT.</p>
