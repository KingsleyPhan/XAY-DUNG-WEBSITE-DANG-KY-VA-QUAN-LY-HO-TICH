...
-->	
	...
	<link rel="stylesheet" type="text/css" href="page/styles/manage.css">
</head>
<body>
<!-- Start Header-->
    ...
    <div id="id-content" class="content-switch">
        <div class="container">
            ...
            <div class="row" style="height: 350px">
                ...
                <div class="row">
                    <div class="col-sm-3 item-paper">
                        <p><a href="#" >Hồ sơ chưa xử lý</a></p>
                    </div>
                    <div class="col-sm-3 item-paper ">
                        <p><a href="#">Hồ sơ đã xử lý</a></p>
                    </div>
                    <div class="col-sm-3 item-paper">
                        <p><a href="#">Hồ sơ đã từ chối</a></p>
                    </div>
                    <div class="col-sm-3  item-paper ">
    ...
    <script src="page/js/Header.js"></script>
</body>
</html>