...
<head>
    ...
    <link href="page/styles/main.css"  rel="stylesheet" type="text/css" >
                        ...
                        <div class="row">
                            <div class="col-sm-9">
                                <select class="form-control" id="comboCoQuan">
                                    <option>SỞ TƯ PHÁP THÀNH PHỐ HỒ CHÍ MINH</option>
                                    <option>SỞ TƯ PHÁP THÀNH PHỐ HÀ NỘI</option>
                                    <option>SỞ TƯ PHÁP TỈNH BẾN TRE</option>
                                    <option>SỞ TƯ PHÁP TỈNH TIỀN GIANG</option>
                                    <option>SỞ TƯ PHÁP TỈNH BẾN TRE</option>
                                    <option>SỞ TƯ PHÁP TỈNH CAO BẰNG</option>
                                    <option>SỞ TƯ PHÁP TỈNH LẠNG SƠN</option>
                                    <option>SỞ TƯ PHÁP TỈNH CÀ MAU</option>
                                </select>
                            </div>
                            <div class="col-sm-3" style="padding:0%">
                                <div class="btn-default btn-search-location" onclick="return SearchCoQuan()">
                                    Tìm kiếm
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" style="background-color: #004f7e"
                                data-dismiss="modal">Đóng</button>
                            <button type="button" class="btn btn-primary" style="background-color: #004f7e">Tiếp tục</button>
                        </div>
                    </div>
                    <!-- /.modal-content -->
                </div>
                    ...
                    <div class="form-switch">
                        ...
                        <div class="content-switch">
                            ...
                            <div class="deprestion">
                                <div class="step">
                                    <a href="javascript:;" class="btn green step-by-step">
                                        <span>
                                            TÌM CƠ QUAN QUẢN LÝ HỘ TỊCH </span>
                                    </a>
                                </div>
                                <div class="step">
                                    <a href="javascript:;" class="btn red step-by-step">
                                        <span>
                                            ĐIỀN THÔNG TIN VÀO TỜ KHAI </span>
                                    </a>
                                </div>
                                <div class="step">
                                    <a href="javascript:;" class="btn purple step-by-step">
                                        <span>
                        ...
                        <div class="content-switch">
                            <form action="loginServlet" class="form-Dang-Nhap">
                                <div class="form-group" style="margin-top: 5px;">
                                    ...
                                    <input type="username" class="form-control" name="username" id="user">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group" style="margin-top: 5px; margin-bottom: 0">
                                    <button type="submit" formmethod="get" class="btn btn-default btn-dn" style="background-color: #004f7e">Đăng
                                        nhập</button>
                                </div>
