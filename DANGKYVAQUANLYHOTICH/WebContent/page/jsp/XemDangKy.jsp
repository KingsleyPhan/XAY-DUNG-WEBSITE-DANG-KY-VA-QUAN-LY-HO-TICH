...
<head>
 <title>HOTICH.NET</title>
    ...
    <link rel="stylesheet" type="text/css" href="page/styles/view.css">
    <!--header and footer-->
</head>
<body>
 <!-- Start Header-->
                        ...
                        <div class="col-12 col-sm-6 col-md-4">
                            <div class="item-paper">
                                <div class="item-body">
                                    ...
                                    <div class="img-icon">
                                        <img src="page/image/baby.png" width="100%">
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-12 ctrls-item">
                                            <form action="GiayKhaiSinh.html">
                        ...
                        <div class="col-12 col-sm-6 col-md-4">
                            <div class="item-paper">
                                <div class="item-body">
                                    ...
                                    <div class="img-icon">
                                        <img src="page/image/kethon.png" width="100%">
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-12 ctrls-item">
                                            <form action="KetHon.html">
                                                <button type="submit" class="item-control">ĐĂNG KÝ MỚI</button>
                                            </form>
                                        </div>
                                    </div>
                        ...
                        <div class="col-12 col-sm-6 col-md-4">
                            <div class="item-paper">
                                <div class="item-body">
                                    ...
                                    <div class="img-icon">
                                        <img src="page/image/chungtu.jpg" width="100%">
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-12 ctrls-item">
                        ...
                        <div class="col-12 col-sm-6 col-md-4">
                            <div class="item-paper">
                                <div class="item-body">
                                    ...
                                    <div class="img-icon">
                                        <img src="page/image/trichluc.png" width="100%">
                                    </div>
                                    <div class="row">
