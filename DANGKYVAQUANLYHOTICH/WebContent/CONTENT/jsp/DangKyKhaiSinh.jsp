							...
							<div class="part-content">
								...
								<div class="content collapse in">
										...
										<div class="col-12 col-sm-6 col-md-4">
											<div class="form-group">
												<label for="">Nơi cấp</label>
												 <input name="NYC_NOICAP" type="text" class="form-control" id="NoiCapCMNDYeuCau"
										...
										<div class="col-12 col-sm-6 col-md-4">
											<div class="form-group">
												<label for="">Quốc tịch </label> <select
													...
													form-control" id="NguoiYeuCau_QuocTich"
									...
									<div class="row">
										<div class="col-12 col-sm-6 col-md-4">
											<div class="form-group">
												<label for="">Tỉnh/TP</label> <select name="NYC_THANHPHO"
													class="form-control" id="NguoiYeuCau_Tinh"
													onblur="validateRequired(NguoiYeuCau_Tinh)">
													<option>Bên Tre</option>
												</select>
														...
														<div class="row">
															<div class="input-group">
																...
																<input name="KS_NGAYSINH" class="form-control"
																	id="KhaiSinh_ngaySinh" placeholder="Ngày/Tháng/Năm"
																	type="text" onblur="validateNgayCap(KhaiSinh_ngaySinh)" />
															</div>
														</div>
													</div>
												</div>
										...
										<div class="col-12 col-sm-6 col-md-4">
											<div class="form-group">
												<label for="">Quận/Huyện</label> <select name="KS_QUAN_CSSS"
													class="form-control" id="KhaiSinh_QuanSinh"
														...
														<div class="row">
															<div class="input-group">
																...
																<input name="ME_NGAYSINH" class="form-control"
																	id="Me_ngaySinh" placeholder="Ngày/Tháng/Năm"
																	type="text" onblur="validateRequired(Me_ngaySinh)" />
															</div>
														</div>
													</div>
												</div>
														...
														<div class="row">
															<div class="input-group">
																...
																<input name="ME_NGAYCAP" class="form-control"
																	id="Me_NgayCap" name="date"
																	placeholder="Ngày/Tháng/Năm"
																	onblur="validateNgayCap(Me_NgayCap)" type="text" />
															</div>
														</div>
													</div>
												</div>
										...
										<div class="col-12 col-sm-6 col-md-4">
											<div class="form-group">
												<label for="">Tỉnh/TP</label> <select name="ME_THANHPHO"
													class="form-control" id="Me_Tinh"
													onblur="validateRequired(Me_Tinh)">
													<option></option>
												</select>
							...
							<div class="part-content">
								...
								<div class="content collapse in" id="CHA">
														...
														<div class="row">
															<div class="input-group">
																...
																<input name="CHA_NGAYSINH" class="form-control"
																	id="Cha_ngaySinh" name="date"
																	placeholder="Ngày/Tháng/Năm" type="text"
																	onblur="validateRequired(Cha_ngaySinh)" />
															</div>
														</div>
													</div>
												</div>
														...
														<div class="row">
															<div class="input-group">
																...
																<input name="CHA_NGAYCAP" class="form-control"
																	id="Cha_NgayCap" naCha="date"
																	placeholder="Ngày/Tháng/Năm"
																	onblur="validateNgayCap(Cha_NgayCap)" type="text" />
															</div>
														</div>
													</div>
												</div>
									...
									<div class="row">
										...
										<div class="col-12 col-sm-6 col-md-4">
											<div class="form-group">
												<label for="">Quốc tịch </label> <select name="CHA_QUOCTICH"
													class="form-control" id="Cha_QuocTich"
										...
										<div class="col-12 col-sm-6 col-md-4">
											<div class="form-group">
												<label for="">Tỉnh/TP</label> <select name="CHA_THANHPHO"
													class="form-control" id="Cha_Tinh"
													onblur="validateRequired(Cha_Tinh)">
													<option></option>
												</select>
				...
				<div class="row">
					<div class="control-navigation">
						...
						<button class="btn  btn-cancel">Hủy bỏ</button>
							...
							<input type="submit" class="btn  btn-continue">Tiếp tục</input>
