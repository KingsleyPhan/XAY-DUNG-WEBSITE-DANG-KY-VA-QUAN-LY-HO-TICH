...
%>
 ...
 <%@page import="Controllers.ConnectDataBase"%>
                ...
                <div class="col-sm-9">
                    <div class="search-location">
                        ...
                        <div class="row">
							...
							conn.connect();
		                    ResultSet rs = conn.DataService("Select THANHPHO_TEN from THANHPHO WHERE THANHPHO_TRANGTHAI=1");
                            %>
                                <select class="form-control" id="comboCoQuan" name="ComboTHANHPHO">
                                 <% while(rs.next())  
                                 	{
                                 %>
                            ...
                            <div class="col-sm-3" style="padding:0%">
                             <form  action = "TimCoQuan.php" method="Post">
